...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 29 05:54:13 2022
...
def isolationforest(filename, parameters, parameter_iteration, parameter_rankings):
    ...
    f_Route_Scores=open("Stats/MatIF_Route_Scores.csv", "a")
...
def get_blind_route(X, gt, filename, parameters_this_file, parameter_iteration, parameter_rankings):
    ...
    plt.xticks(ticks= [])
    plt.title(filename)
    plt.savefig("Fig/GD/Routes/"+filename+"_MatIF_Trajectory.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
    ...
    plt.title(filename)
    plt.savefig("Fig/GD/Routes/"+filename+"_MatIF_Trajectory_W_F1.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()
    return blind_route
...
def get_guided_route(X, gt, filename, parameters_this_file, parameter_iteration, parameter_rankings):
    ...
    plt.title(filename)
    plt.savefig("Fig/GD/Routes/"+filename+"_MatIF_Guided_Trajectory_W_F1.pdf", bbox_inches="tight", pad_inches=0)
    plt.show()    
...
def plot_ari_f1():
    Route_Scores = pd.read_csv("Stats/MatIF_Route_Scores.csv")
